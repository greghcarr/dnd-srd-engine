# Archive: slices 282-299 (alpha.8 cohort)

Per-slice detail for the alpha.8 release (slices 282-299), moved here in slice 303 when the live CHANGELOG crossed the 60 KB single-Read ceiling. The alpha.8 summary block + headline themes stay in [../../CHANGELOG.md](../../CHANGELOG.md) under `## 0.1.0-alpha.8`. Mirrors the slice 270 / 277 / 288 archive cadence.
