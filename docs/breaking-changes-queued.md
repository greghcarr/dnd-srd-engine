...
Items that landed on `dev` after the most-recent tagged release ([0.2.0-alpha.0](../CHANGELOG.md), 2026-06-03) and constitute consumer-facing breaking changes. When the next release tag is cut, these become the release-notes "Breaking" section.
