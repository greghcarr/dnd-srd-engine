...
Items that landed on `dev` after the most-recent tagged release ([0.6.0-alpha.0](../CHANGELOG.md), 2026-06-05) and constitute consumer-facing breaking changes. When the next release tag is cut, these become the release-notes "Breaking" section.
