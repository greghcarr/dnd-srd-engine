...
- **Spell area target selection.** Area spells (Burning Hands, Fireball, Entangle) take `targetIds: string[]` from your app. The engine doesn't compute "who's in the cube/sphere/line" from positions — that's a spatial query in your app's hands.
