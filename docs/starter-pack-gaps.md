...
| Spells | 351 (339 SRD + 12 non-SRD) | ~340 (SRD 5.2.1) | 164 wired via `mechanicalEffects` plus 11 dedicated planners. Per-level wired-vs-schema-only catalog in [gaps-spells.md](gaps-spells.md). |
