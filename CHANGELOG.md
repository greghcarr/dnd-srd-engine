...
The live CHANGELOG reached ~60 KB (the single-Read ceiling). Per the doc-size playbook, the per-slice detail for slices 350-351 moved to [docs/changelog/archive-slices-350-351.md](docs/changelog/archive-slices-350-351.md); the live file keeps the most recent slice (352) inline plus a pointer, dropping to ~54 KB. Added the new file to the archive index. No code or content change; doc-size audit green.
