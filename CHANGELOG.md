...
Also archived the slices 411-413 CHANGELOG cohort to [docs/changelog/archive-slices-411-413.md](docs/changelog/archive-slices-411-413.md) (the live CHANGELOG had no headroom under the 60 KB single-Read ceiling); left the standard pointer.
