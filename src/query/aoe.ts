...
import { parseSpellRange } from '../engine/plan/_spatial-gates.js';
...
// The canonical "who's in the area" query. Given a spell with an authored
// `targeting` (shape + size), the caster, and an aim point, returns the
// combatant ids whose cell the template covers AND that have line of effect
// from the point of origin (a creature behind Total Cover inside the radius
// isn't hit). This is the shared rasterizer the [L7 audit] `aoe-shape-
...
// catches your own party. The caller applies saves/damage to the returned
// ids (slice 787 wires this into cast-spell behind an opt-in aim).
//
