...
import {
  ...
  SuffocationExhaustionChangedEventSchema,
  ConfusionBehaviorRolledEventSchema,
...
import {
  ...
  AuraDamageBudgetSpentEventSchema,
...
import {
  ...
  AmmunitionQuantityChangedEventSchema,
  ItemUsedEventSchema,
...
export const EVENT_TYPES = [
  ...
  'CreaturePushed',
  'ExhaustionChanged',
  'SuffocationExhaustionChanged',
  'ConfusionBehaviorRolled',
  'DeathSaveRolled',
  'Stabilized',
  'CreatureDestroyed',
  'HPMaxBonusChanged',
